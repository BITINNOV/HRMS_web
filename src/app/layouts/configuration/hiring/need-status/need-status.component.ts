...
export class NeedStatusComponent implements OnInit {
  ...
  loadData() {
    this.spinner.show();
    this.subscriptions.add(this.needStatusService.size().subscribe(
      data => {
        this.collectionSize = data;
      }
    ));
    this.subscriptions.add(this.needStatusService.findAllPagination(this.page, this.size).subscribe(
      data => {
