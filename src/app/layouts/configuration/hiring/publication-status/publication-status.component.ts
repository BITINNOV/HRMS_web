...
export class PublicationStatusComponent implements OnInit {
  ...
  loadData() {
    this.spinner.show();
    this.subscriptions.add(this.publicationStatusService.size().subscribe(
      data => {
        this.collectionSize = data;
      }
    ));
    this.subscriptions.add(this.publicationStatusService.findAllPagination(this.page, this.size).subscribe(
      data => {
